...
const fixtures = [
  ...
  { id: "kakao/04-maeyeon", kind: "image", file: "fixtures/kakao/04-maeyeon.png", expectPeople: 3, names: ["윤서아", "장하람", "권도현"], forbidden: ["민수", "나"], keys: { 윤서아: [["works_at", "네이버"], ["job_title", "PM"], ["interested_in", "러닝"], ["met_at", "매연"]], 장하람: [["works_at", "하람"], ["job_title", "대표"], ["met_at", "매연"]], 권도현: [["works_at", "노스스타"], ["job_title", "심사"], ["met_at", "매연"]] } },
